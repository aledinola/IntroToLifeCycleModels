...
sum(StationaryDist.ptype001*StationaryDist.ptweights(1)+...
    StationaryDist.ptype002*StationaryDist.ptweights(2)+...
    StationaryDist.ptype003*StationaryDist.ptweights(3)+...
    StationaryDist.ptype004*StationaryDist.ptweights(4)+...
    StationaryDist.ptype005*StationaryDist.ptweights(5),"all")
